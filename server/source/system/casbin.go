...
func (i *initCasbin) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []adapter.CasbinRule{
		...
		//{Ptype: "p", V0: "1", V1: "/contact/contact", V2: "GET"},
		//{Ptype: "p", V0: "1", V1: "/contact/contact", V2: "PUT"},
		//{Ptype: "p", V0: "1", V1: "/contact/contact", V2: "POST"},
		//{Ptype: "p", V0: "1", V1: "/contact/contact", V2: "DELETE"},
		//{Ptype: "p", V0: "1", V1: "/contact/customerList", V2: "GET"},
		...
		//{Ptype: "p", V0: "2", V1: "/contact/contact", V2: "POST"},
		//{Ptype: "p", V0: "2", V1: "/contact/contact", V2: "PUT"},
		//{Ptype: "p", V0: "2", V1: "/contact/contact", V2: "DELETE"},
		//{Ptype: "p", V0: "2", V1: "/contact/contact", V2: "GET"},
		//{Ptype: "p", V0: "2", V1: "/contact/customerList", V2: "GET"},
		...
		//{Ptype: "p", V0: "3", V1: "/contact/contact", V2: "PUT"},
		//{Ptype: "p", V0: "3", V1: "/contact/contact", V2: "GET"},
		//{Ptype: "p", V0: "3", V1: "/contact/contact", V2: "POST"},
		//{Ptype: "p", V0: "3", V1: "/contact/contact", V2: "DELETE"},
		//{Ptype: "p", V0: "3", V1: "/contact/customerList", V2: "GET"},
