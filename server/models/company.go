...
type Company struct {
	...
	EconomicActivityCode    string           `json:"economicActivityCode" gorm:"size:10; not null"`
	EconomicActivity        EconomicActivity `gorm:"foreignKey:EconomicActivityCode;references:Code"`
	ActivitySecondaryOne    string           `json:"activitySecondaryOne" gorm:"size:10; not null"`
	ActivitySecondaryTwo    string           `json:"activitySecondaryTwo" gorm:"size:10; not null"`
	...
	Currency                Currency         `gorm:"foreignKey:CurrencyCode;references:Code" validate:"-"`
	...
	InvoicePreferences      datatypes.JSON   `json:"invoicePreferences"`
	common.ModelTime
	common.ControlBy
}
