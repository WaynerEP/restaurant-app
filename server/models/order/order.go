...
type MenuOrder struct {
	...
	FloorEnvironmentTables []reservation.FloorEnvironmentTable `json:"floorEnvironmentTables" gorm:"many2many:menu_order_floor_environment_table"` // Many-to-many relationship with FloorEnvironmentTable
	common.ModelTime
	common.ControlBy
}
